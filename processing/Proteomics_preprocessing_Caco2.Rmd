...
samples$condition <- c("R2_Caco2_U", "R2_Caco2_T", "R2_Caco2_U", "R2_Caco2_T","R2_Caco2_U", "R2_Caco2_T")
...
```{r}
list_comp <- c("R2_Caco2_T-R2_Caco2_U")
```
...
```
```{r}
pdf("results/virus_levels/Caco2_virus_levels_difference.pdf")
a<- ggplot(data_virus_2, aes(x=Proteins, y=value, fill = "#1F78B4"))+
  geom_bar(stat="identity", position=position_dodge())+
  scale_fill_manual(values =c("#B2DF8A"))+ theme_minimal()+ 
...
```{r}
pdf("results/virus_levels/Caco2_virus_levels.pdf", height = 5)
